...
const featuredArticle = {
  ...
  image: "/images/article-card-1.jpg",
  category: "Tech News",
  timeAgo: "2 hours ago",
  author: "Sarah Chen",
  readTime: "8 min read",
...
const timelineArticles = [
  { title: "Microsoft acquires AI startup for $2.1B in largest deal this quarter", image: "/images/article-thumb-1.jpg", category: "Tech News", timeAgo: "3 hours ago", time: "14:30" },
  { title: "Stack Overflow reports 40% surge in AI-related questions", image: "/images/article-thumb-2.jpg", category: "Tech News", timeAgo: "5 hours ago", time: "12:00" },
  { title: "European universities launch joint CS curriculum initiative", image: "/images/article-thumb-3.jpg", category: "Student News", timeAgo: "6 hours ago", time: "10:45" },
  { title: "Rust surpasses Go in developer satisfaction survey 2026", image: "/images/article-thumb-4.jpg", category: "Tech News", timeAgo: "8 hours ago", time: "08:30" },
  { title: "MIT opens free advanced ML certification for undergraduates", image: "/images/article-thumb-5.jpg", category: "Student News", timeAgo: "10 hours ago", time: "06:15" },
  { title: "Apple unveils new developer tools at WWDC 2026 preview", image: "/images/article-card-2.jpg", category: "Tech News", timeAgo: "12 hours ago", time: "04:00" },
];

const gridArticles = [
  { title: "Why Every Student Should Learn Systems Design in 2026", image: "/images/article-card-3.jpg", category: "Student News", timeAgo: "1 day ago" },
  { title: "The Complete Guide to Open Source Contributions for Beginners", image: "/images/article-card-4.jpg", category: "Tech News", timeAgo: "1 day ago" },
  { title: "How AI Code Assistants Are Reshaping Computer Science Education", image: "/images/article-card-2.jpg", category: "Student News", timeAgo: "2 days ago" },
  { title: "Top 15 Tech Conferences for Students in 2026", image: "/images/article-thumb-1.jpg", category: "Student News", timeAgo: "2 days ago" },
  { title: "WebAssembly 3.0: What Developers Need to Know", image: "/images/article-thumb-3.jpg", category: "Tech News", timeAgo: "3 days ago" },
  { title: "The State of Remote Internships: A 2026 Report", image: "/images/article-thumb-5.jpg", category: "Student News", timeAgo: "3 days ago" },
];

const trendingSidebar = [
  { title: "AI Coding Assistants Compared: Copilot vs Cursor vs Cody", image: "/images/article-thumb-2.jpg", category: "Tech News", timeAgo: "4h ago" },
  { title: "Student-Built App Reaches 1M Users in 30 Days", image: "/images/article-thumb-4.jpg", category: "Student News", timeAgo: "6h ago" },
  { title: "Linux Foundation Announces Free Cloud Certifications", image: "/images/article-card-1.jpg", category: "Tech News", timeAgo: "8h ago" },
  { title: "How a CS Dropout Built a $50M SaaS Company", image: "/images/article-thumb-1.jpg", category: "Tech News", timeAgo: "12h ago" },
];

const NewsCategoryPage = ({ slug }: { slug?: string }) => {
