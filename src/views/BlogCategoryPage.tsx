...
const featuredPost = {
  ...
  timeAgo: "6 hours ago",
  author: { name: "Sarah Chen", avatar: "/images/article-thumb-1.jpg" },
  readTime: "12 min read",
};

const editorPicks = [
  { title: "Why Every Developer Should Understand System Design", image: "/images/article-card-2.jpg", category: "Industry Insights", timeAgo: "1 day ago", author: "James Lee", readTime: "8 min" },
  { title: "Top 10 VS Code Extensions You Need in 2026", image: "/images/article-card-3.jpg", category: "Tool Reviews", timeAgo: "2 days ago", author: "Alex Kim", readTime: "6 min" },
  { title: "From Dorm Room to $10M ARR: A Student Startup Story", image: "/images/article-card-4.jpg", category: "Startup Stories", timeAgo: "3 days ago", author: "Maria Garcia", readTime: "10 min" },
];

const recentPosts = [
  { title: "How Cursor Is Changing the Way We Code", image: "/images/article-thumb-1.jpg", category: "Tool Reviews", timeAgo: "4 days ago", author: "Tom Wilson", readTime: "7 min" },
  { title: "Understanding RAG: A Developer's Guide", image: "/images/article-thumb-2.jpg", category: "Tech Articles", timeAgo: "5 days ago", author: "Priya Patel", readTime: "9 min" },
  { title: "The Future of Open Source in the AI Era", image: "/images/article-thumb-3.jpg", category: "Industry Insights", timeAgo: "1 week ago", author: "David Park", readTime: "11 min" },
  { title: "Building a SaaS in 30 Days: Lessons Learned", image: "/images/article-thumb-4.jpg", category: "Startup Stories", timeAgo: "1 week ago", author: "Nina Brown", readTime: "8 min" },
  { title: "Comparing Bun, Deno, and Node.js in 2026", image: "/images/article-thumb-5.jpg", category: "Tech Articles", timeAgo: "1 week ago", author: "Chris Adams", readTime: "10 min" },
  { title: "The Developer Tools Market Map 2026", image: "/images/article-card-2.jpg", category: "Tool Reviews", timeAgo: "2 weeks ago", author: "Sarah Chen", readTime: "15 min" },
];

const topAuthors = [
  { name: "Sarah Chen", role: "Senior Tech Writer", articles: 42, avatar: "/images/article-thumb-1.jpg" },
  { name: "James Lee", role: "Engineering Lead", articles: 28, avatar: "/images/article-thumb-3.jpg" },
  { name: "Priya Patel", role: "AI Researcher", articles: 19, avatar: "/images/article-thumb-5.jpg" },
];

const BlogCategoryPage = ({ slug }: { slug?: string }) => {
