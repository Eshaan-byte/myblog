...
const tutorials = [
  { title: "Building a REST API with Node.js and Express", image: "/images/article-thumb-1.jpg", category: "Programming", difficulty: "Beginner", duration: "45 min", author: "James Lee", tags: ["Node.js", "Backend"] },
  { title: "Complete Guide to React Server Components", image: "/images/article-thumb-2.jpg", category: "Tutorials", difficulty: "Intermediate", duration: "30 min", author: "Sarah Chen", tags: ["React", "Frontend"] },
  { title: "How to Land Your First Tech Internship", image: "/images/article-thumb-3.jpg", category: "Career Guides", difficulty: "Beginner", duration: "20 min", author: "Maria Garcia", tags: ["Career", "Tips"] },
  { title: "Mastering TypeScript Generics: A Visual Guide", image: "/images/article-thumb-4.jpg", category: "Programming", difficulty: "Advanced", duration: "35 min", author: "Alex Kim", tags: ["TypeScript"] },
  { title: "Docker for Beginners: A Hands-On Tutorial", image: "/images/article-thumb-5.jpg", category: "Tutorials", difficulty: "Beginner", duration: "50 min", author: "David Park", tags: ["Docker", "DevOps"] },
  { title: "System Design Interview: Complete Roadmap", image: "/images/article-card-1.jpg", category: "Career Guides", difficulty: "Advanced", duration: "60 min", author: "Priya Patel", tags: ["System Design"] },
  { title: "Understanding Git Internals and Advanced Workflows", image: "/images/article-card-2.jpg", category: "Programming", difficulty: "Intermediate", duration: "40 min", author: "Tom Wilson", tags: ["Git", "Tools"] },
  { title: "Building Your First Mobile App with React Native", image: "/images/article-card-3.jpg", category: "Tutorials", difficulty: "Beginner", duration: "55 min", author: "Nina Brown", tags: ["React Native", "Mobile"] },
];
...
const LearnCategoryPage = ({ slug }: { slug?: string }) => {
