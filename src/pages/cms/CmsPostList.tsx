                ...
                <tr key={p.id} className="transition-colors hover:bg-white/[0.02]" style={{ borderBottom: "1px solid #2a2d3e22" }}>
                  ...
                  <td className="py-2.5 px-3">
                    <div className="flex items-center gap-1">
                      <button onClick={() => navigate(`/cms/posts/edit/${p.id}`)} className="p-1.5 rounded hover:bg-white/10" aria-label="Edit"><Edit className="w-3.5 h-3.5" /></button>
                      <button onClick={() => navigate(`/article/${p.slug}`)} className="p-1.5 rounded hover:bg-white/10" aria-label="Preview"><Eye className="w-3.5 h-3.5" /></button>
